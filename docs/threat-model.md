...
This is a design document with partial implementation evidence. Core implements declared-file reads, size bounds, link/path rejection, strict decoding, structural validation and content-free diagnostics. Step 3 added validated side-table references and source-tree write rejection. Step 4 adds staged complete snapshots, CSV formula neutralisation and tested summary disclosure boundaries. Quarantine, HTML-report and MCP defenses remain specifications.
